...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { battery: @phone.battery, cpu: @phone.cpu, manufacturer: @phone.manufacturer, name: @phone.name, price: @phone.price, screen: @phone.screen }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { battery: @phone.battery, cpu: @phone.cpu, manufacturer: @phone.manufacturer, name: @phone.name, price: @phone.price, screen: @phone.screen }
    assert_redirected_to phone_path(assigns(:phone))
  end
